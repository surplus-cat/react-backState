...
class Draggable extends React.Component {
  ...
  handleMousemove = (e) => {
    const { pageX, pageY, transformX, transformY, canMove } = this.state;
  ...
  initTriggerDomRang = () => {
    this.domRangParams = {
      triggerWidth: this.trigger.clientWidth || this.triggerDom.documentElement.clientWidth,
      triggerHeight: this.trigger.clientHeight || this.triggerDom.documentElement.clientHeight,
